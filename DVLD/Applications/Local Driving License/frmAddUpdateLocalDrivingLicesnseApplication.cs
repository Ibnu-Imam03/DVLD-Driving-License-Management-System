...
namespace DVLD.Applications.Local_Driving_License
{
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        public frmAddUpdateLocalDrivingLicesnseApplication()
        {
            InitializeComponent();
            _Mode = enMode.AddNew;
            clsPersonCardWithFilter1.OnPersonSelected += ctrlPersonCardWithFilter1_OnPersonSelected;
        }
        public frmAddUpdateLocalDrivingLicesnseApplication(int LocalDrivingLicenseApplication)
        {
            InitializeComponent();
        ...
        private void _ResetDefaltValues()
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                lblFees.Text = clsApplicationTypes.GetApplictionTypesByID((int)clsApplication.enApplicationType.NewDrivingLicense).Fee.ToString();
        ...
        private void _LoadData()
        {
            ...
            clsPersonCardWithFilter1.LoadPersonInfo(_LocalDrivingLicenseApplication.ApplicantPersonID);
            lblLocalDrivingLicebseApplicationID.Text = _LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID.ToString();
            lblApplicationDate.Text = _LocalDrivingLicenseApplication.ApplicationDate.ToString("dd/MMM/yyyy");
        ...
        private void DataBackEvent(object sender, int PersonID)
        {
            ...
            clsPersonCardWithFilter1.LoadPersonInfo(PersonID);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (clsLicense.IsLicenseExistByPersonID(clsPersonCardWithFilter1.PersonID, LicenseClassID))
            {
                MessageBox.Show("Person already have a license with the same applied driving class, Choose diffrent driving class", "Not allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            _LocalDrivingLicenseApplication.ApplicationPersonID =clsPersonCardWithFilter1.PersonID;
            _LocalDrivingLicenseApplication.ApplicantPersonID = clsPersonCardWithFilter1.PersonID;
